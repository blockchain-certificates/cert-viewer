...
1. First ensure you have Docker installed. [See our Docker installation help](https://github.com/blockchain-certificates/blockchain-certificates.github.io/blob/master/docs/docker_install.md).
